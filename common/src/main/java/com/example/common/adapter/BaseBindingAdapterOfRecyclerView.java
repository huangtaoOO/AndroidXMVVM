...
public abstract class BaseBindingAdapterOfRecyclerView<M, B extends ViewDataBinding> extends RecyclerView.Adapter<BaseBindingAdapterOfRecyclerView.BaseBindingViewHolder> {
    ...
    @NonNull
    @Override
    public BaseBindingAdapterOfRecyclerView.BaseBindingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BaseBindingAdapterOfRecyclerView.BaseBindingViewHolder holder, int position) {
    ...
    public static <T> void resetList(List<T> src, List<T> dest){
        ...
        if (dest.size() > src.size()){
            dest.subList(src.size(), dest.size()).clear();
        }
    }
